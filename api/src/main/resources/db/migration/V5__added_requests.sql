drop table if exists director_entity cascade;
drop table if exists director_entity_movies cascade;
...
drop table if exists screening_entity cascade;
...
create table friend_request_entity (id bigint not null, status varchar(255), receiver_id bigint, sender_id bigint, primary key (id));
create table message_entity (id bigint not null, creation_time timestamp, text varchar(1500), receiver_id bigint, sender_id bigint, primary key (id));
...
create table user_entity (id bigint not null, email varchar(300), family_name varchar(350), given_name varchar(250), primary key (id));
