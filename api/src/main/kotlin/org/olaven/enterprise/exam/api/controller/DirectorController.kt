package org.olaven.enterprise.exam.movies.controller

import com.google.common.base.Throwables
import io.swagger.annotations.*
import org.olaven.enterprise.exam.movies.Transformer
import org.olaven.enterprise.exam.shared.response.DirectorResponseDTO
import org.olaven.enterprise.exam.movies.repository.DirectorRepository
import org.olaven.enterprise.exam.movies.repository.paginatedResponse
...
class DirectorController(
    ...
    @ApiResponses(
            ApiResponse(code = 200, message = "Receiving api")
    )
